...
<br>
   ...
   <div class="card" id="CardFormulario">
     ...
     <div class="card-content">
       <div class="content">
           <p class="subtitulos">Toca el siguiente botón para realizar su pedido</p>
           <button class='button is-dark'><a href='realizarpedido_cafeteria.php'>Realizar pedido</a></button>
       </div>
     </div>
   </div>
